...
if __name__ == '__main__':
    # train_text, train_label = read_data(os.path.join("./output/", "test.txt"))
    train_text, train_label = read_data(os.path.join("./output/", "train_sample.txt"))
    dev_text, dev_label = read_data(os.path.join("./output/", "test_sample.txt"))
